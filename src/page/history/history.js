            ...
            <View contentContainerStyle={styles.main}>
                {
                    ...
                    <View>
                        ...
                        /> */}
                        {
                            this.state.historyShop.map((item, index)=>(
                                <SwipeRow key={index} style={styles.listSwipe} rightOpenValue={-130}>
                                    <View style={styles.rowBack}>
                                        <View style={styles.rightRowBack}>
                                            <TouchableOpacity style={{paddingHorizontal:5}} onPress={()=>this.detailsData(item.messageId)}>
                                                <Icon  name='information-circle' size={45} color='#01579B' />
                                            </TouchableOpacity>
                                            <TouchableOpacity style={{paddingHorizontal:5}} onPress={()=>this.deleteButton(item.messageId)}>
                                                <Icon name='trash' size={45} color='#B71C1C' />
                                            </TouchableOpacity>
                                        </View>
                                    </View>
